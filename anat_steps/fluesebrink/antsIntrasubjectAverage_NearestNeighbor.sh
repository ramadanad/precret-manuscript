...
############  DR: end of commenting out this part ################

# For container execution: tools are in the PATH, no need for ANTSPATH
...
# Check if tools are available in PATH (for container execution)
# Skip the executable check since tools may not be directly executable in PATH
# Instead, we'll rely on the container having these tools available
echo "ANTs tools will be executed from container PATH"
echo "Using: ANTS=$ANTS, WARP=$WARP, N4=$N4"
