...
hold off
plot((0:length(X)-1)*TR, X, 'color', [0.072192 0.282249 0.380434], 'linewidth', 2.5); %predicted % batlow # 38
hold on
plot((0:length(Y)-1)*TR*Model.Downsample_Predictions, Y, '-o', 'MarkerSize', 3, 'MarkerFaceColor', [0.746850 0.563725 0.207375], 'color', [0.746850 0.563725 0.207375 0.5], 'linewidth', 2.5); %observed % batlow # 160
xlim([0 length(X)]*TR);
grid on
